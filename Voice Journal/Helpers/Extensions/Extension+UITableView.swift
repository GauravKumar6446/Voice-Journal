...
public extension UITableView {
    ...
    func registerView(type: UITableViewHeaderFooterView.Type, identifier: String? = nil) {
        let viewId = String(describing: type)
        register(UINib(nibName: viewId, bundle: nil), forHeaderFooterViewReuseIdentifier: identifier ?? viewId)
    }
    /**
    ...
    func dequeueView<T: UITableViewHeaderFooterView>(withType type: UITableViewHeaderFooterView.Type) -> T? {
